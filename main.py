...
class Main():
    def __init__(self, root):
       ...
       # self.photoimg = ImageTk.PhotoImage(back_icon)
        ...
        # Safaricom Button
        safaricom_btn = Button(self.root,command=self.safaricom, text="Safaricom+",text_color="black",width=360,border_width=0,corner_radius=0,
        ...
        # Mpesa Button
        mpesa_btn = Button(self.root,command=self.mpesa, text="M-PESA",text_color="black",width=360,border_width=0,corner_radius=0,
         fg_color="white", bg_color="white", font=("Bookman old Style", 17), hover_color="light gray", anchor=W, height=42)
